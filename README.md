...
```bash
   $ git clone https://github.com/yogeshkaremore3/social-distancing-detector-using-deep-learning.git
   $ cd social-distancing-detector-using-deep-learning
...
3. Run the main social distancing detector file.
```bash
   $ python run.py
```
...
- Email - yogeshkaremore3@gmail.com :e-mail:
- Let's connect on <a href="https://www.linkedin.com/in/yogesh-karemore-74aaa7159/">LinkedIn.</a> :pushpin:
